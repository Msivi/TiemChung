...
namespace TiemChung.Controllers
{
    ...
    public class ThongTinTiemChungController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("/api/[controller]/get-thong-tin-tiem-chung-by-id")]
        ...
        [HttpPut]
        [Route("/api/[controller]/update-thong-tin-tiem-chung-nhan-vien")]
        ...
        [HttpDelete]
        [Route("/api/[controller]/delete-thong-tin-tiem-chung")]
        public async Task<ActionResult<ThongTinTiemChungEntity>> DeleteThongTinTiemChung(string keyId)
        {

            try
            {

                await _thongTinTiemChung.DeleteThongTinTiemChung(keyId, false);
                return Ok(new BaseResponseModel<string>(
                    statusCode: StatusCodes.Status200OK,
                    code: "Success!",
